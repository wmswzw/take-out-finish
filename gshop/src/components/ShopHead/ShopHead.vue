  ...
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back" @click="$router.back()">
        <!-- <router-link to="/msite" class="back"> -->
        <i class="iconfont icon-jiantou2"></i>
        <!-- </router-link> -->
      </a>
    </nav>
    <div class="shop-content" @click="tabShopShow">
    ...
    <div class="shop-header-discounts" v-if="shopinfo.supports" @click="tabSupportsShow" >
    ...
    <div class="shop-brief-modal" v-show="ShopShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="tabShopShow">
    ...
    <div class="activity-sheet" v-show="SupportsShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="tabSupportsShow">
          <span class="iconfont icon-guanbi"></span>
        </div>
      </div>
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .shop-header
    ...
    .shop-brief-modal
      ...
      color #333
      &.fade-enter-active,&.dafe-leave-active
        transition all .5s
      &.fade-enter,&.dafe-leave-to
        opacity:0
      .brief-modal-cover
        position absolute
        width 100%
