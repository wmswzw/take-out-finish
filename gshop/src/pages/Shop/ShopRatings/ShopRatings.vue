        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-like-' : 'icon-dislike-'"></span>
...
export default {
  ...
  //   }
  // },
  // 在computed里获取shopinfo和shopratings的State数据以及返回好评数量的Getters
  computed: {
